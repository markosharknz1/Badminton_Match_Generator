...
function pay(db, playerId, categoryId, amountCents) {
    db.run(`UPDATE attendance SET payment_category_id = ?, payment_amount_cents = ? WHERE session_id = 1 AND player_id = ?`, [categoryId, amountCents, playerId]);
}
let nextGameId = 1000;
